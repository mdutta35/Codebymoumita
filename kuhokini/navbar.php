            ...
            <ul class="list-group">
              ...
              <li class="list-group-item">
                <div class="d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
                  data-bs-target="#shopByCategoryList" aria-expanded="false" aria-controls="shopByCategoryList"
              ...
              <li class="list-group-item">
                <div class="d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
                  data-bs-target="#shopByPriceList" aria-expanded="false" aria-controls="shopByPriceList"
                  style="cursor: pointer;">
                  <span><i class="bi bi-bag-heart"></i> Wishlist</span>
              ...
              <li class="list-group-item">
                <div class="d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
                  data-bs-target="#bestsellersList" aria-expanded="false" aria-controls="bestsellersList"
                  style="cursor: pointer;">
              ...
              <div class="border">
                ...
                <li class="list-group-item">
                  <div class="d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
                    data-bs-target="#mensCollectionList" aria-expanded="false" aria-controls="mensCollectionList"
                    style="cursor: pointer;">
