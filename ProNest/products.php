            ...
            <div class="col">
                <div class="card h-100 bg-light">
                    ...
                    <div class="card-body">
                        ...
                        <a href="solar_panel.php" class="btn">Learn More</a>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col">
                <div class="card h-100 bg-light">
                    ...
                    <div class="card-body">
                        ...
                        <a href="home_improvement.php" class="btn">Learn More</a>
                    </div>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="col">
                <div class="card h-100 bg-light">
                    ...
                    <div class="card-body">
                        ...
                        <a href="home_insulation.php" class="btn">Learn More</a>
                    </div>
                </div>
            </div>
            <!-- Card 4 -->
            <div class="col">
                <div class="card h-100 bg-light">
                    ...
                    <div class="card-body">
                        ...
                        <a href="windows_doors.php" class="btn">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
